...
const AdminDashboard = () => {
    ...
    useEffect(() => {
        const fetchUsers = async () => {
            try {
                const response = await fetch('https://lucky-1-6ma5.onrender.com/api/users/');
    ...
    const handleDeleteUser = async () => {
        try {
            const response = await fetch(`https://lucky-1-6ma5.onrender.com/api/users/users/${userIdToDelete}`, {
                method: 'DELETE',
                headers: {
    ...
    const handleUpdateUser = async (updatedUser) => {
        try {
            const response = await fetch(`https://lucky-1-6ma5.onrender.com/api/users/users/${updatedUser._id}`, {
                method: 'PUT',
                headers: {
                    'Content-Type': 'application/json',
                },
